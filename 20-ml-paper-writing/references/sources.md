...
### Paragraph-Density Exemplars (published ML papers used as style anchors)

| Source | Author | URL | Key Contribution |
|--------|--------|-----|------------------|
| **MMLongBench** (NeurIPS 2025) | Wang et al. | [arXiv:2505.10610](https://arxiv.org/abs/2505.10610) | Analysis / method / related-work paragraph density exemplar — see `references/sections/paragraph-density-mmlongbench.md` |
